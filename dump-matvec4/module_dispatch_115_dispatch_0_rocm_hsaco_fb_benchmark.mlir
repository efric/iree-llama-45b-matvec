module {
  ...
  hal.executable private @dispatch_115_dispatch_0 {
  ...
  util.global private mutable @dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer
  util.initializer {
    ...
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%queue_affinity) type(%memory_type) usage(%buffer_usage) : !hal.buffer{%c218341376}
    util.global.store %buffer, @dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer
    util.return
  }
  util.func public @dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer = util.global.load @dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@dispatch_115_dispatch_0::@rocm_hsaco_fb::@dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@dispatch_115_dispatch_0) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@dispatch_115_dispatch_0::@rocm_hsaco_fb::@dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c0, %c131072], 
        (%dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c131072, %c218103808], 
        (%dispatch_115_dispatch_0_rocm_hsaco_fb_dispatch_115_dispatch_0_matmul_like_4x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c218234880, %c106496]
      ]) flags("None")
